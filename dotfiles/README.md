...
This folder contains my dotfiles and instructions to install the very basic software I use on my machines.  
It also functions as template for my other features.
