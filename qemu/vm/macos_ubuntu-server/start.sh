...
qemu_args=(
  ...
  -virtfs local,path=../../../shell,mount_tag=shell,security_model=mapped-file,id=shell,readonly=on
  -virtfs local,path=../../../software,mount_tag=software,security_model=mapped-file,id=software,readonly=on
  # Installation ISO
